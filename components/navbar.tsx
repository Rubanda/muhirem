...
export const NavBar = () => {
  ...
  return (
    <header className="m-auto max-w-2xl px-3">
        ...
        <nav className="flex items-center space-x-1">
          <Link
            ...
            className={`inline-flex hover:bg-gray-100 dark:hover:bg-[#313131]
             ${pathname==='/projects'  ? 'underline underline-offset-1': 'text-foreground'}  rounded-sm p-2 transition-[background-color]`}>
            Projects
          </Link>
          {/* <Link
            href="/about"
          ...
          <a
            href="https://github.com/Rubanda"
            target="_blank"
            className='hover:bg-gray-200 dark:hover:bg-[#313131]  items-center p-2 rounded-sm transition-[background-color] whitespace-nowrap -mr-2'
          >
